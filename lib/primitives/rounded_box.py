...
from build123d import Align, Axis, Box, Part, Pos, RectangleRounded, chamfer, extrude, fillet
...
@component(
    id="primitives.box_lid", version="1.0.0",
    ...
    units={"length": "mm", "width": "mm", "wall": "mm", "corner_r": "mm", "thickness": "mm", "lip_height": "mm",
           "lip_thickness": "mm", "clearance": "mm", "top_chamfer": "mm"},
    descriptions={
...
def box_lid(
    ...
    assembled on the box); flip for printing.
    ...
    lip = extrude(RectangleRounded(lo, wo, r_out) - RectangleRounded(lo - 2 * lip_thickness, wo - 2 * lip_thickness, r_in), amount=-lip_height)
    return plate + lip
